...
class TestCross(unittest.TestCase):
    def test_forward(self):
        ...
        c_cpu = neural_renderer_torch.cross(a_cpu, b_cpu).data
        c_gpu = neural_renderer_torch.cross(a_gpu, b_gpu).data
    ...
    def test_backward_cpu(self):
        ...
        chainer.gradient_check.check_backward(neural_renderer_torch.cross, (a, b), gy, atol=1e-3, rtol=1e-3)
